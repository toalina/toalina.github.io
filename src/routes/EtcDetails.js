    ...
    return (
      <div className='etc-details'>
        ...
        <div className='etc-text-wrapper'>
          <p>Alina is a modern day Renaissance woman: A musician. A linguist (Bachelors of Arts in Linguistics). An educator (Masters of Arts in Teaching English). A software developer. A sewist. A baker. A creator. A strategic eater. A lifelong learner. A bilingual bicultural human.</p>
